...
class PIM03:
    ...
    def login(self):
        try:
            ...
            self.sleep(5)
            self.findElementByXpath('//*[@id="app"]/div[1]/div[2]/div[2]/div/div[2]/div[3]/div/div[2]/div[1]/div/div[9]/div/button[1]').click()
            self.sleep(3)
            self.findElementByXpath('//*[@id="app"]/div[3]/div/div/div/div[3]/button[2]').click()
            self.sleep(3)
